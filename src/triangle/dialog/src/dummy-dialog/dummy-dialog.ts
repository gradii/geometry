...
export class DummyDialog {
  ...
  @ContentChild('dialog-close-template', {read: TemplateRef, static: false})
  titleTemplate: TemplateRef<any>;

  @Input() content;

  @ContentChild('dialog-content-template', {read: TemplateRef, static: false})
  contentTemplate: TemplateRef<any>;

  @Input() footer;

  @ContentChild('dialog-actions-template', {read: TemplateRef, static: false})
