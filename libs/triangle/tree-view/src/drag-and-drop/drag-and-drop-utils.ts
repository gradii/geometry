...
import { closestNode, closestWithMatch, getContentElement, hasParent, isContent, isPresent, nodeId } from '../utils';
...
export const ɵ2 = isBottomReached;
/**
 * @hidden
 *
