 ...
 */
task('release:build-release', ['release:prepare-release'], () => composeRelease(trianglePackage));
 ...
 */
task('release:prepare-release', sequenceTask(
  ['release:build'],
...
task('release:copy-prebuilt-themes', () => {
...
task('release:bundle-theming-scss', () => {
