  ...
  template     : `
    <div [ngClass]="_classMap" *ngIf="_display" [@fadeAnimation]>
      <i
        ...
        [class.triicon-cross-circle-o]="type==='error'"
        [class.triicon-check-circle-o]="type==='success'"
        [class.triicon-info-circle-o]="type==='info'"
        [class.triicon-exclamation-circle-o]="type==='warning'"
        *ngIf="showIcon&&description"></i>
      <i
        class="ant-alert-icon anticon"
        [class.triicon-cross-circle]="type==='error'"
        [class.triicon-check-circle]="type==='success'"
        [class.triicon-info-circle]="type==='info'"
        [class.triicon-exclamation-circle]="type==='warning'"
        *ngIf="showIcon&&!description"></i>
