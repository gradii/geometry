...
import {
  A, DOWN_ARROW, ENTER, hasModifierKey, LEFT_ARROW, RIGHT_ARROW, SPACE, UP_ARROW,
} from '@angular/cdk/keycodes';
import { CdkConnectedOverlay, ConnectedPosition, ScrollStrategy, } from '@angular/cdk/overlay';
import { ViewportRuler } from '@angular/cdk/scrolling';
import {
  AfterContentInit, Attribute, ChangeDetectorRef, Directive, DoCheck, ElementRef, EventEmitter,
  Inject, Input, NgZone, OnChanges, OnDestroy, OnInit, Optional, Output, QueryList, Self,
...
import {
  distinctUntilChanged, filter, map, startWith, switchMap, take, takeUntil,
} from 'rxjs/operators';
import { TRI_SELECT_CONFIG, TriSelectConfig } from './select-config';
import {
  getTriSelectDynamicMultipleError, getTriSelectNonArrayValueError,
...
/** Base class with all of the `TriSelect` functionality. */
@Directive()
