...
describe('test interpolate string', () => {
  ...
  it('interpolateString(a, b) interpolates matching numbers in a and b keep remain literal', () => {
    expect(interpolateString('2px', '12px')(0.2)).toBe('4px');
    expect(interpolateString('2px', '12px')(0.4)).toBe('6px');
  });
