...
@Component({
  ...
  template     : `
    ...
    <div class="ant-tabs-nav-container"
         [class.ant-tabs-nav-container-scrolling]="_showPaginationControls"
         #tabListContainer>
      <span class="ant-tabs-tab-prev ant-tabs-tab-arrow-show"
            [class.ant-tabs-tab-btn-disabled]="_disableScrollBefore"
      ...
      <span class="ant-tabs-tab-next ant-tabs-tab-arrow-show"
            [class.ant-tabs-tab-btn-disabled]="_disableScrollAfter"
      ...
      <div class="ant-tabs-nav-wrap">
        <div class="ant-tabs-nav-scroll">
          <div class="ant-tabs-nav" [class.ant-tabs-nav-animated]="animated" #tabList
...
export class TabsNavComponent implements AfterContentChecked, AfterContentInit {
  ...
  @HostBinding('class.ant-tabs-bar') _tabsBar = true;
