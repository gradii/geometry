...
@Component({
  selector : 'tri-demo-dnd-grid-resize',
  template : `
    <div>
      <div class="">
        <h2>To do</h2>
        ...
        <div style="display: flex; flex-direction: row; gap:10px; height: 800px;">
          ...
          <div triDropGridContainer #gridContainer="triDropGridContainer"
               ...
               [triDropGridContainerMaxRows]="12"
  ...
  `,
  styleUrls: ['tri-demo-dnd-grid-resize.component.scss']
})
export class TriDemoDndGridResizeComponent implements AfterViewInit {
  hasPadding = true;
