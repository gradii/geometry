...
export type TimelineMode = 'left' | 'alternate' | 'right' | 'both-but-other-left' | 'both-but-other-right'
    ...
    <ul class="tri-timeline"
      ...
      <li *ngIf="pending" class="tri-timeline-item tri-timeline-item-pending">
        ...
        <div class="tri-timeline-item-head tri-timeline-item-head-blue">
          {{pendingDot}}<i *ngIf="!pendingDot" class="anticon anticon-loading anticon-spin"></i>
        </div>
