...
export class DemoButtonComponent implements OnInit {
  ...
  // DemoButtonSizeCode = require('!!raw-loader!./nz-demo-button-size.component');
  // DemoButtonLoadingCode = require('!!raw-loader!./nz-demo-button-loading.component');
  // DemoButtonIconCode = require('!!raw-loader!./nz-demo-button-icon.component');
  // DemoButtonGroupCode = require('!!raw-loader!./nz-demo-button-group.component');
