...
export class _TriContextMenuBase implements AfterContentInit, TriContextMenuPanel<TriContextMenuItem>, OnInit,
  ...
  readonly panelId = `tri-context-menu-panel-${menuPanelUid++}`;
  ...
  setPositionClasses(posX: MenuPositionX = this.xPosition, posY: MenuPositionY = this.yPosition) {
    ...
    classes['tri-context-menu-before'] = posX === 'before';
    classes['tri-context-menu-after'] = posX === 'after';
    classes['tri-context-menu-above'] = posY === 'above';
    classes['tri-context-menu-below'] = posY === 'below';
  }
