import { Component, ContentChild, EventEmitter, Inject, Input, OnChanges, OnDestroy, OnInit, Output, SimpleChanges, ViewChild } from '@angular/core';
...
export class TreeComponent implements OnInit, OnChanges, OnDestroy {
  ...
  @ContentChild(TreeRenderTemplateDirective, {read: TreeRenderTemplateDirective}) public renderTemplate: TreeRenderTemplateDirective;

  @ContentChild(TreeCommandTemplateDirective, {read: TreeCommandTemplateDirective}) public commandTemplate: TreeCommandTemplateDirective;
