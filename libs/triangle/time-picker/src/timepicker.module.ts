 ...
 *
 ...
 ### 代码演示
 最简单的用法。
 <!-- example(tri-demo-time-picker-basic) -->
 三种大小的输入框，大的用在表单中，中的为默认。
 <!-- example(tri-demo-time-picker-size) -->
 禁用时间选择。
 <!-- example(tri-demo-time-picker-disabled) -->
 通过  `nzHideDisabledOptions`  将不可选的选项隐藏。
 <!-- example(tri-demo-time-picker-hide-options) -->
 value 和 nzValueChange 需要配合使用。
 <!-- example(tri-demo-time-picker-change) -->
 不展示秒，也不允许选择。
 <!-- example(tri-demo-time-picker-without-seconds) -->
 限制选择  `20:30`  到  `23:30`  这个时间段。
 <!-- example(tri-demo-time-picker-disabled-options) -->
 */
@NgModule({
