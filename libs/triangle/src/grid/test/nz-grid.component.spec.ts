...
@Component({
  ...
  template: `
    <div tri-row>
      <div tri-col style="background-color: #0e639c" [nzSpan]="_span">
        col-{{_span}}
      </div>
      <div tri-col style="background-color: #00a0e9" [nzSpan]="_span">
        col-{{_span}}
      </div>
    </div>
  `
...
@Component({
  ...
  template: `
    <div tri-row>
      <div tri-col [nzSpan]="_span1" [nzOffset]="_offset1" style="background-color: #0e639c">
        col-{{_span1}}-{{_offset1}}
      </div>
      <div tri-col [nzSpan]="_span2" [nzOffset]="_offset2" style="background-color: #00a0e9">
        col-{{_span2}}-{{_offset2}}
      </div>
    </div>
  `
...
@Component({
  ...
  template: `
    <div tri-row>
      <div tri-col [nzSpan]="_span1" [nzPush]="_push" [nzPull]="_pull" style="background-color: #0e639c">
...
@Component({
  ...
  template: `
    <div tri-row [type]="_type" [justify]="_justify" [align]="_align">
      <div tri-col [nzSpan]="4" style="background-color: #00a0e9">
        col-4
      </div>
      <div tri-col [nzSpan]="4" style="background-color: #00a2ae">
        col-4
      </div>
      <div tri-col [nzSpan]="4" style="background-color: #00a854">
        col-4
      </div>
    </div>
  `
...
@Component({
  ...
  template: `
    <div tri-row [type]="_type">
      <div tri-col [nzSpan]="6" [nzOrder]="_order1" style="background-color: #00a854">
        NO1 : col-order-{{_order1}}
      </div>
      <div tri-col [nzSpan]="6" [nzOrder]="_order2" style="background-color: #00a0e9">
