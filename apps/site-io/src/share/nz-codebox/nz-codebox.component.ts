  ...
  template     : `
                   <section class="code-box" [ngClass]="{'expand':nzExpanded}">
                     ...
                     <section class="code-box-meta markdown">
                       ...
                       <tri-tooltip [title]="nzExpanded?'收起代码':'展开代码'">
                        <span class="code-expand-icon" tri-tooltip (click)="nzExpanded=!nzExpanded">
                       ...
                       <div class="highlight">
                         <div class="code-box-actions">
                           <tri-tooltip [title]="'复制代码'">
                             <i tri-tooltip class="anticon code-box-code-copy"
                                [class.anticon-copy]="!_copied"
                                [class.anticon-check]="_copied"
                                [class.ant-tooltip-open]="_copied"
                                (click)="copyCode(_code)"></i>
                           </tri-tooltip>
                         </div>
