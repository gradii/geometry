...
def karma_web_test_suite(name, **kwargs):
    ...
    if not hasattr(kwargs, "browsers"):
        ...
        kwargs["browsers"] = [
            ...
            "//tools/dev-infra-angular/bazel/browsers/chromium:chromium",
            "//tools/dev-infra-angular/bazel/browsers/firefox:firefox",
        ]
...
def protractor_web_test_suite(**kwargs):
    _protractor_web_test_suite(
        browsers = ["/tools/dev-infra-angular/bazel/browsers/chromium:chromium"],
        **kwargs
    )
