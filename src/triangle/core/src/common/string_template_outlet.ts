...
export class StringTemplateOutletDirective {
  ...
  set stringTemplateOutlet(value: string | TemplateRef<void>) {
    if (value instanceof TemplateRef) {
      ...
      this.inputTemplate = value as TemplateRef<void>;
    } else {
    ...
    if (!this.isTemplate) {
      ...
      if (!this.defaultViewRef) {
        ...
        if (this.defaultTemplate) {
          this.defaultViewRef = this.viewContainer.createEmbeddedView<void>(this.defaultTemplate);
        }
      }
    } else {
      ...
      if (!this.inputViewRef) {
        ...
        if (this.inputTemplate) {
          this.inputViewRef = this.viewContainer.createEmbeddedView<void>(this.inputTemplate);
        }
      }
    }
  }
