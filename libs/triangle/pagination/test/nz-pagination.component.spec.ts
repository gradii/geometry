...
describe('TriPaginationComponent', () => {
  ...
  describe('for tri-pagination', () => {
    it('the correct pages are displayed and the previous page is disabled or not disabled', () => {
      ...
      expect(
        debugElement.nativeElement.querySelector('.tri-pagination-prev').classList.contains('ant-pagination-disabled')
      ).toBe(true);
      ...
      expect(
        debugElement.nativeElement.querySelector('.tri-pagination-next').classList.contains('ant-pagination-disabled')
      ).toBe(true);
    ...
    it('simply flip the page', () => {
      ...
      fixture.detectChanges();
      expect(
        debugElement.nativeElement.querySelector('.tri-pagination').classList.contains('ant-pagination-simple')
      ).toBe(true);
    });
