import difference from '../../helpers/_/difference';
import {InvalidGrant, InvalidScope} from '../../helpers/errors';
import presence from '../../helpers/validate_presence';
import instance from '../../helpers/weak_cache';
import revoke from '../../helpers/revoke';
const { 'x5t#S256': thumbprint } = require('../../helpers/calculate_thumbprint');
import formatters from '../../helpers/formatters';
import filterClaims from '../../helpers/filter_claims';
import dpopValidate from '../../helpers/validate_dpop';
import resolveResource from '../../helpers/resolve_resource';
...
export let parameters = new Set(['refresh_token', 'scope']);
