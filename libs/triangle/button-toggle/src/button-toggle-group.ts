...
import {
  AfterContentInit, ChangeDetectorRef, ContentChildren, Directive, EventEmitter, forwardRef, Inject,
  Input, OnInit, Optional, Output, QueryList
} from '@angular/core';
import { ControlValueAccessor, NG_VALUE_ACCESSOR } from '@angular/forms';
import { TriButtonToggle } from './button-toggle';
import { TriButtonToggleChange } from './event';
import {
  TRI_BUTTON_TOGGLE_DEFAULT_OPTIONS, TRI_BUTTON_TOGGLE_GROUP, TriButtonToggleAppearance,
...
@Directive({
  ...
  host     : {
    ...
    '[class.tri-button-toggle-group-appearance-standard]': 'appearance === "standard"',
  },
...
export class TriButtonToggleGroup implements ControlValueAccessor, OnInit, AfterContentInit {
  ...
  @Input() appearance: TriButtonToggleAppearance;
