          ...
          <ul class="ant-select-dropdown-menu ant-select-dropdown-menu-vertical ant-select-dropdown-menu-root"
            ...
            <ng-template ngFor let-option [ngForOf]="_filterOptions">
              <li *ngIf="!_optionTemplate"
                  [class.ant-select-dropdown-menu-item-disabled]="option.disabled"
                  [class.ant-select-dropdown-menu-item-active]="option.value == _activeFilterOption?.value"
                  [class.ant-select-dropdown-menu-item-selected]="(option.value==(_selectedOption?.value))||(isInSet(_selectedOptions,option))"
