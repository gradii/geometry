...
export class TabsNavComponent implements AfterContentChecked, AfterContentInit {
  ...
  @Input() hideBar = false;
  @Input() size = 'default';
  @ContentChild('tabBarExtraContent', {static: false}) _tabBarExtraContent: TemplateRef<any>;
  @ContentChildren(TabLabelDirective) _labelWrappers: QueryList<TabLabelDirective>;
  @ViewChild(TabsInkBarDirective, {static: false}) _inkBar: TabsInkBarDirective;
