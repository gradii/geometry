...
export class SelectComponent implements ControlValueAccessor, OnInit, AfterViewInit, OnDestroy, AfterContentInit {
  ...
  @ViewChild(SelectTopControlComponent, {static: false}) selectTopControlComponent: SelectTopControlComponent;
  ...
  @ContentChildren(OptionGroupComponent) listOfOptionGroupComponent: QueryList<OptionGroupComponent>;
