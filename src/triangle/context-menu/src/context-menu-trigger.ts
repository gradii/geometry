...
export const TRI_CONTEXT_MENU_SCROLL_STRATEGY =
    new InjectionToken<() => ScrollStrategy>('tri-context-menu-scroll-strategy');

/** @docs-private */
export function TRI_CONTEXT_MENU_SCROLL_STRATEGY_FACTORY(overlay: Overlay): () => ScrollStrategy {
  return () => overlay.scrollStrategies.reposition();
}

/** @docs-private */
export const TRI_CONTEXT_MENU_SCROLL_STRATEGY_FACTORY_PROVIDER = {
  provide: TRI_CONTEXT_MENU_SCROLL_STRATEGY,
  deps: [Overlay],
  useFactory: TRI_CONTEXT_MENU_SCROLL_STRATEGY_FACTORY,
};
...
@Directive({
  ...
  host: {
    'class': 'tri-context-menu-trigger',
    'aria-haspopup': 'true',
  ...
  exportAs: 'triContextMenuTrigger'
})
export class TriContextMenuTrigger implements AfterContentInit, OnDestroy {
  ...
  private _getOverlayConfig(): OverlayConfig {
    return new OverlayConfig({
      positionStrategy: this._overlay.position()
          ...
          .withLockedPosition()
          .withGrowAfterOpen()
          .withTransformOriginOn('.tri-context-menu-panel, .mat-mdc-menu-panel'),
