...
load("//tools/dev-infra-angular/bazel/browsers/chromium:chromium.bzl", "define_chromium_repositories")
load("//tools/dev-infra-angular/bazel/browsers/firefox:firefox.bzl", "define_firefox_repositories")
