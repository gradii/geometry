...
@Component({
  ...
  template: `
    <div>
      ...
      <tri-button-group>
        <button tri-button [ghost]="true" (click)="minCount()"><i class="anticon anticon-minus"></i></button>
        <button tri-button [ghost]="true" (click)="addCount()"><i class="anticon anticon-plus"></i></button>
      </tri-button-group>
    </div>
