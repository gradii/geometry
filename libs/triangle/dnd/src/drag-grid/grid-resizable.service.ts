...
import { DirTypes } from './grid-config.interface';
...
import { GridResizeEventType } from './grid-resize-event-type.interface';

// import { cancelScroll, scroll } from './grid-sc.service';
import { GridUtilsService } from './grid-utils.service';

export class GridResizableService {
  ...
  itemBackup: number[];
  resizeEventScrollType: GridResizeEventType;
  ...
  dragStart(e: MouseEvent): void {
    ...
    this.width               = this.gridsterItem.renderWidth;
    this.height              = this.gridsterItem.renderHeight;
    this.bottom              = this.gridsterItem.top + this.gridsterItem.renderHeight;
    this.right               = this.gridsterItem.left + this.gridsterItem.renderWidth;
    ...
    this.minHeight           =
      this.gridster.positionYToPixels(
        this.gridsterItem.minItemRows
      ) - this.margin;
    this.minWidth            =
      this.gridster.positionXToPixels(
        this.gridsterItem.minItemCols
      ) - this.margin;
  ...
  dragMove = (e: MouseEvent): void => {
    ...
    e.stopPropagation();
    e.preventDefault();
    GridUtilsService.checkTouchEvent(e);
    this.offsetTop  = this.gridster.el.scrollTop - this.gridster.el.offsetTop;
    this.offsetLeft = this.gridster.el.scrollLeft - this.gridster.el.offsetLeft;
    // scroll(
    //   this.gridster,
  ...
  cancelResize = (): void => {
    this.gridsterItem.renderCols = this.gridsterItem.cols || 1;
    this.gridsterItem.renderRows = this.gridsterItem.rows || 1;
  ...
  private handleNorth = (e: MouseEvent): void => {
    ...
    if (this.gridsterItem.renderY !== this.newPosition) {
      this.itemBackup[1]        = this.gridsterItem.renderY;
      this.itemBackup[3]        = this.gridsterItem.renderRows;
      this.gridsterItem.renderRows +=
        this.gridsterItem.renderY - this.newPosition;
      this.gridsterItem.renderY = this.newPosition;
      ...
      if (this.gridster.checkCollision(this.gridsterItem)) {
        this.gridsterItem.renderY    = this.itemBackup[1];
        this.gridsterItem.renderRows = this.itemBackup[3];
        this.setItemTop(
          this.gridster.positionYToPixels(this.gridsterItem.renderY)
        );
        this.setItemHeight(
          this.gridster.positionYToPixels(this.gridsterItem.renderRows) -
          this.margin
        );
        return;
      } else {
  ...
  private handleWest = (e: MouseEvent): void => {
    ...
    if (this.gridsterItem.renderX !== this.newPosition) {
      this.itemBackup[0]        = this.gridsterItem.renderX;
      this.itemBackup[2]        = this.gridsterItem.renderCols;
      this.gridsterItem.renderCols +=
        this.gridsterItem.renderX - this.newPosition;
      this.gridsterItem.renderX = this.newPosition;
      ...
      if (this.gridster.checkCollision(this.gridsterItem)) {
        this.gridsterItem.renderX    = this.itemBackup[0];
        this.gridsterItem.renderCols = this.itemBackup[2];
        this.setItemLeft(
          this.gridster.positionXToPixels(this.gridsterItem.renderX)
        );
        this.setItemWidth(
          this.gridster.positionXToPixels(this.gridsterItem.renderCols) -
          this.margin
        );
        return;
      } else {
  ...
  private handleSouth = (e: MouseEvent): void => {
    ...
    if (
      this.gridsterItem.renderY + this.gridsterItem.renderRows !==
      this.newPosition
    ) {
      this.itemBackup[3]           = this.gridsterItem.renderRows;
      this.gridsterItem.renderRows =
        this.newPosition - this.gridsterItem.renderY;
  ...
  private handleEast = (e: MouseEvent): void => {
    ...
    if (
      this.gridsterItem.renderX + this.gridsterItem.renderCols !==
      this.newPosition
    ) {
      this.itemBackup[2]           = this.gridsterItem.renderCols;
      this.gridsterItem.renderCols =
        this.newPosition - this.gridsterItem.renderX;
      this.pushResize.pushItems(this.gridsterItem._dragRef, this.pushResize.fromWest);
      this.push.pushItems(
        this.gridsterItem._dragRef,
        this.push.fromWest,
        this.gridster.$options.disablePushOnResize
      );
      if (this.gridster.checkCollision(this.gridsterItem)) {
  ...
  dragStartDelay(e: MouseEvent | TouchEvent): void {
    ...
    //   GridUtilsService.checkTouchEvent(eventMove);
    //   if (
