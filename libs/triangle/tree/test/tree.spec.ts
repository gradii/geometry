...
import { dispatchMouseEvent, dispatchTouchEvent } from '@gradii/triangle/core/testing';

import { TreeService } from '../src/tree.service';
import { TreeNode } from '../src/tree-node';
import { TreeComponent } from '../src/tree.component';
import { TriTreeModule } from '../src/tree.module';
...
describe('tree', () => {
  ...
  describe('basic tree', () => {
    let fixture: ComponentFixture<TestTreeBasicControlledComponent>;
    let treeInstance: TestTreeBasicControlledComponent;

    beforeEach(async(() => {
      TestBed.configureTestingModule({
        imports     : [ TriTreeModule, NoopAnimationsModule, FormsModule, ReactiveFormsModule ],
        declarations: [ TestTreeBasicControlledComponent ]
      }).compileComponents();
      fixture = TestBed.createComponent(TestTreeBasicControlledComponent);
      treeService = fixture.componentInstance.treeComponent.treeService;
      fixture.detectChanges();
      treeInstance = fixture.debugElement.componentInstance;
      treeElement = fixture.debugElement.query(By.directive(TreeComponent)).nativeElement;
    }));
    it('should create', () => {
      expect(treeInstance).toBeDefined();
    });

    it('should set defaultXXX correctly', fakeAsync(() => {
      fixture.detectChanges();
      flush();
      tick(300);
      fixture.detectChanges();
    ...
    it('test new TreeNode of data', fakeAsync(() => {
      treeInstance.nodes = [ {
        title   : '0-0',
        key     : '0-0',
        expanded: true,
        ...
        return (new TreeNode(v, undefined, treeService));
      });
      fixture.detectChanges();
      tick(100);
      fixture.detectChanges();
    ...
    it('test click event', fakeAsync(() => {
      fixture.detectChanges();
      const clickSpy = spyOn(treeInstance, 'event');
      // click 0-0-0 to select
      let targetNode = treeElement.querySelectorAll('tri-tree-node')[ 1 ];
      dispatchMouseEvent(targetNode, 'click');
      fixture.detectChanges();
      // 0-0-0 / 0-0-0-0 are selected
      expect(treeElement.querySelectorAll('.tri-tree-node-selected').length).toEqual(2);
      ...
      targetNode = treeElement.querySelectorAll('tri-tree-node')[ 1 ];
      dispatchMouseEvent(targetNode, 'dblclick');
      fixture.detectChanges();
      // 0-0-0-0 are selected
      expect(treeElement.querySelectorAll('.tri-tree-node-selected').length).toEqual(1);
      expect(treeInstance.treeComponent.getSelectedNodeList().length).toEqual(1);
      expect(clickSpy).toHaveBeenCalledTimes(3); // will detect dblclick

      // click disabled node
      targetNode = treeElement.querySelectorAll('tri-tree-node')[ treeElement.querySelectorAll('tri-tree-node').length - 1 ];
      dispatchMouseEvent(targetNode, 'click');
      fixture.detectChanges();
      expect(treeElement.querySelectorAll('.tri-tree-node-selected').length).toEqual(1);

      // set multiple to false, click 0-0-0-0 will just active one node
      treeInstance.multiple = false;
      fixture.detectChanges();
      targetNode = treeElement.querySelectorAll('tri-tree-node')[ 0 ];
      dispatchMouseEvent(targetNode, 'click');
      fixture.detectChanges();
      expect(treeElement.querySelectorAll('.tri-tree-node-selected').length).toEqual(1);
      expect(treeInstance.treeComponent.getSelectedNodeList().length).toEqual(1);
      ...
      dispatchMouseEvent(targetNode, 'click');
      fixture.detectChanges();
      expect(treeElement.querySelectorAll('.tri-tree-node-selected').length).toEqual(0);
    ...
    it('test expand event', fakeAsync(() => {
      ...
      const targetNode = treeElement.querySelectorAll('.tri-tree-switcher')[ 0 ];
      ...
      expect(treeElement.querySelectorAll('.tri-tree-switcher_open').length).toEqual(3);
    }));

    it('test check event', fakeAsync(() => {
      fixture.detectChanges();
      // uncheck 0-0-0
      let targetNode = treeElement.querySelectorAll('.tri-tree-checkbox')[ 1 ];
      ...
      expect(treeElement.querySelectorAll('.tri-tree-checkbox-checked').length).toEqual(0);

      // check 0-0-0, will make 0-0 indeterminate
      targetNode = treeElement.querySelectorAll('.tri-tree-checkbox')[ 1 ];
      dispatchMouseEvent(targetNode, 'click');
      tick(300);
      fixture.detectChanges();
      expect(fixture.componentInstance.treeComponent.getCheckedNodeList().length).toEqual(1);
    ...
    it('test check event with checkStrictly', fakeAsync(() => {
      fixture.detectChanges();
      ...
      let targetNode = treeElement.querySelectorAll('.tri-tree-checkbox')[ 0 ];
      dispatchMouseEvent(targetNode, 'click');
      fixture.detectChanges();
      expect(fixture.componentInstance.treeComponent.getCheckedNodeList().length).toEqual(1);
      expect(treeElement.querySelectorAll('.tri-tree-checkbox-checked').length).toEqual(1);

      targetNode = treeElement.querySelectorAll('.tri-tree-checkbox')[ 1 ];
      dispatchMouseEvent(targetNode, 'click');
      fixture.detectChanges();
      expect(fixture.componentInstance.treeComponent.getCheckedNodeList().length).toEqual(2);
      expect(treeElement.querySelectorAll('.tri-tree-checkbox-checked').length).toEqual(2);
    ...
    it('test contextmenu event', fakeAsync(() => {
      ...
      const clickSpy = spyOn(treeInstance, 'event');
      // contextmenu 0-0-0
      const targetNode = treeElement.querySelectorAll('tri-tree-node')[ 1 ];
    ...
    it('test disabled node check event', fakeAsync(() => {
      ...
      const clickSpy = spyOn(treeInstance, 'event');
      // contextmenu 0-0-0
      const targetNode = treeElement.querySelectorAll('.tri-tree-checkbox')[ treeElement.querySelectorAll('li').length - 1 ];
      dispatchMouseEvent(targetNode, 'click');
      fixture.detectChanges();
    ...
    it('test async loading', fakeAsync(() => {
      ...
      tick();
      fixture.detectChanges();
      let targetNode = treeElement.querySelectorAll('.tri-tree-switcher')[ 0 ];
      dispatchMouseEvent(targetNode, 'click');
      tick();
      fixture.detectChanges();
      expect(treeElement.querySelectorAll('.tri-tree-treenode-loading').length).toEqual(1);
      expect(treeElement.querySelectorAll('.tri-tree-switcher_open').length).toEqual(1);
      ...
      fixture.detectChanges();
      expect(treeElement.querySelectorAll('.tri-tree-treenode-loading').length).toEqual(0);
      expect(fixture.componentInstance.treeComponent.getExpandedNodeList().length).toEqual(1);

      // add treeNode children to clear loading state
      targetNode = treeElement.querySelectorAll('.tri-tree-switcher')[ 2 ];
      dispatchMouseEvent(targetNode, 'click');
      tick();
      fixture.detectChanges();
      ...
      expect(fixture.componentInstance.treeComponent.getExpandedNodeList().length).toEqual(2);
      expect(treeElement.querySelectorAll('.tri-tree-treenode-loading').length).toEqual(1);
      fixture.componentInstance.treeComponent.getExpandedNodeList()[ 1 ].addChildren([ new TreeNode({
        title: 'Child Node',
        key  : `1-0`
      }) ]);
      fixture.detectChanges();
      expect(treeElement.querySelectorAll('.tri-tree-treenode-loading').length).toEqual(0);
      expect(treeElement.querySelectorAll('.tri-tree-switcher_open').length).toEqual(2);
      expect(fixture.componentInstance.treeComponent.getExpandedNodeList().length).toEqual(2);
    }));

    it('test set treeNode', fakeAsync(() => {
      // get 0-0 node
      ...
      fixture.detectChanges();
      expect(treeElement.querySelector('.tri-tree-treenode-disabled')!.querySelectorAll('[title=\'0-0-reset\']').length).toEqual(1);
    }));
  });

  describe('test draggable node', () => {
    let fixture: ComponentFixture<TestTreeDraggableComponent>;
    let treeInstance: TestTreeDraggableComponent;

    beforeEach(async(() => {
      TestBed.configureTestingModule({
        imports     : [ TriTreeModule, NoopAnimationsModule, FormsModule, ReactiveFormsModule ],
        declarations: [ TestTreeDraggableComponent ],
        providers   : [
          TreeService
        ]
      }).compileComponents();
    ...
    beforeEach(async(() => {
      fixture = TestBed.createComponent(TestTreeDraggableComponent);
      treeService = fixture.componentInstance.treeComponent.treeService;
      fixture.detectChanges();
      treeInstance = fixture.debugElement.componentInstance;
      treeElement = fixture.debugElement.query(By.directive(TreeComponent)).nativeElement;
    ...
    it('test drag event', fakeAsync(() => {
      ...
      expect(dragNode.previousElementSibling!.classList).toContain('tri-tree-switcher_close');
      expect(dropNode.previousElementSibling!.classList).toContain('tri-tree-switcher_open');
  ...
  describe('test older node property', () => {
    let fixture: ComponentFixture<TestTreeOlderComponent>;
    let treeInstance: TestTreeOlderComponent;

    beforeEach(async(() => {
      TestBed.configureTestingModule({
        imports     : [ TriTreeModule, NoopAnimationsModule, FormsModule, ReactiveFormsModule ],
        declarations: [ TestTreeOlderComponent ],
        providers   : [
          TreeService
        ]
      }).compileComponents();
    ...
    beforeEach(async(() => {
      fixture = TestBed.createComponent(TestTreeOlderComponent);
      treeService = fixture.componentInstance.treeComponent.treeService;
      fixture.detectChanges();
      treeInstance = fixture.debugElement.componentInstance;
      treeElement = fixture.debugElement.query(By.directive(TreeComponent)).nativeElement;
    ...
    it('test node function', fakeAsync(() => {
      ...
      fixture.detectChanges();
      // add treeNode children to clear loading state, root click will not change
      const targetNode = treeElement.querySelectorAll('li')[ 0 ];
      expect(targetNode.querySelectorAll('.tri-tree-treenode-selected').length).toEqual(0);
      dispatchMouseEvent(targetNode, 'click');
      fixture.detectChanges();
      expect(targetNode.querySelectorAll('.tri-tree-treenode-selected').length).toEqual(0);
    }));
...
@Component({
  selector: 'test-tree-basic-controlled',
  template: `
    <tri-tree
      #treeComponent
      [dataSource]="nodes"
...
export class TestTreeBasicControlledComponent {
...
export class TestTreeDraggableComponent {
  @ViewChild(TreeComponent) treeComponent: TreeComponent;
  nodes = [ {
    title   : '0-0',
    key     : '00',
...
@Component({
  ...
  template: `
    <tri-tree
      ...
      [expandAll]="expandDefault">
    </tri-tree>
  `
})
export class TestTreeOlderComponent implements OnInit {
  @ViewChild(TreeComponent) treeComponent: TreeComponent;
  ...
  ngOnInit(): void {
    this.modelNodes = [
      ...
      return new TreeNode(n, undefined, this.treeComponent.treeService);
    });
  }
}
