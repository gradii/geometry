...
export class TriOptionSelectionEvent {
  constructor(
 ...
 */
export const TRI_OPTION_PARENT_COMPONENT =
  new InjectionToken<TriOptionParentComponent>('TRI_OPTION_PARENT_COMPONENT');
...
@Component({
  ...
  host           : {
    ...
    '[class.tri-option-selected]': 'selected',
    '[class.tri-option-multiple]': 'multiple',
    '[class.tri-option-active]'         : 'active',
    '[id]'                       : 'id',
...
export class OptionComponent implements AfterViewChecked, OnDestroy {
  ...
  @Output() readonly onSelectionChange = new EventEmitter<TriOptionSelectionEvent>();
  ...
  private _emitSelectionChangeEvent(isUserInput = false): void {
    this.onSelectionChange.emit(new TriOptionSelectionEvent(this, isUserInput));
  }
}
...
export function _countGroupLabelsBeforeOption(optionIndex: number, options: QueryList<OptionComponent>,
                                              optionGroups: QueryList<OptionGroupComponent>): number {
