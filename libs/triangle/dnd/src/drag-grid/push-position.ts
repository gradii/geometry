...
// import { any, any } from '@gradii/triangle/gridster';

export class PushPosition {
  public fromSouth: string;
  public fromNorth: string;
  public fromEast: string;
  public fromWest: string;
  private pushedItems: any[];
  private pushedItemsTemp: any[];
  private pushedItemsTempPath: { x: number, y: number }[][];
  private pushedItemsPath: { x: number, y: number }[][];
  private gridsterItem: any;
  private gridster: any;
  private pushedItemsOrder: any[];
  private tryPattern: {
    fromEast: ((gridsterItemCollide: any,
                gridsterItem: any) => boolean)[],
    fromWest: ((gridsterItemCollide: any,
                gridsterItem: any) => boolean)[],
    fromNorth: ((gridsterItemCollide: any,
                 gridsterItem: any) => boolean)[],
    fromSouth: ((gridsterItemCollide: any,
                 gridsterItem: any) => boolean)[]
  };
  private iteration = 0;

  constructor(gridsterItem: any) {
    this.pushedItems         = [];
  ...
  private push(gridsterItem: any, direction: string): boolean {
    ...
    const conflicts: any[] = this.gridster.findItemsWithItem(
      gridsterItem.$item);
  ...
  private trySouth(gridsterItemCollide: any,
                   gridsterItem: any): boolean {
  ...
  private tryNorth(gridsterItemCollide: any,
                   gridsterItem: any): boolean {
  ...
  private tryEast(gridsterItemCollide: any,
                  gridsterItem: any): boolean {
  ...
  private tryWest(gridsterItemCollide: any,
                  gridsterItem: any): boolean {
  ...
  private addToTempPushed(gridsterItem: any): void {
  ...
  private removeFromTempPushed(gridsterItem: any): void {
  ...
  private addToPushed(gridsterItem: any): void {
  ...
  private removeFromPushedItem(gridsterItem: any): void {
    const i = this.pushedItems.indexOf(gridsterItem);
    if (i > -1) {
  ...
  private checkPushedItem(pushedItem: any, i: number): boolean {
