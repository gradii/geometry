...
import {
  CompactType, GridsterConfig, GridsterItem, GridsterItemComponent, GridsterItemComponentInterface,
  GridsterPush, GridType
...
export class ApiComponent implements OnInit {
    ...
    this.dashboard = [
      {
        ...
        y           : 0,
        x           : 0,
        initCallback: (item, itemComponent) => this.initItem(item, itemComponent)
      },
  ...
  initItem(item: GridsterItem, itemComponent: GridsterItemComponentInterface): void {
