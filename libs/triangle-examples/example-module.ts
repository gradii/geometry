...
import { TriDemoDatePickerFormatterComponent } from './tri-demo-datepicker/tri-demo-datepicker-formatter.component';
...
// import { TriDemoTagColorfulComponent } from './tri-demo-tag/tri-demo-tag-colorful.component';
...
export const EXAMPLE_COMPONENTS = {
  ...
  'date-picker-formatter': {
    title: 'datepicker-formatter',
    relativePath: 'tri-demo-datepicker/tri-demo-datepicker-formatter.component.ts',
    component: TriDemoDatePickerFormatterComponent,
    additionalFiles: null,
    selectorName: null
  },
  'date-picker-size': {
  ...
  // 'tag-colorful'                 : {
  //   title          : 'tag-colorful',
  //   relativePath   : 'tri-demo-tag/tri-demo-tag-colorful.component.ts',
  //   component      : TriDemoTagColorfulComponent,
  //   additionalFiles: null,
  //   selectorName   : null
  // },
  'tag-control': {
...
export const EXAMPLE_LIST = [
  ...
  TriDemoDatePickerFormatterComponent,
