...
describe('test database connection', () => {
  ...
  it('select one calls select and returns single result', () => {
    const connection = this.getMockConnection(['select']);
  ...
  it('select properly calls pdo', () => {
    ...
    const mock = this.getMockConnection(['prepareBindings'], writePdo);
    mock.setReadPdo(pdo);
  ...
  it('insert calls the statement method', () => {
    const connection = this.getMockConnection(['statement']);
  ...
  it('update calls the affecting statement method', () => {
    const connection = this.getMockConnection(['affectingStatement']);
  ...
  it('statement properly calls pdo', () => {
    ...
    const mock = this.getMockConnection(['prepareBindings'], pdo);
  ...
  it('transaction level not incremented on transaction exception', () => {
    ...
    const connection = this.getMockConnection([], pdo);
    try {
  ...
  it('begin transaction method retries on failure', () => {
    ...
    const connection = this.getMockConnection(['reconnect'], pdo);
  ...
  it('began transaction fires events if set', () => {
    const pdo        = this.createMock(DatabaseConnectionTestMockPDO);
    const connection = this.getMockConnection(['getName'], pdo);
  ...
  it('transaction method runs successfully', () => {
    ...
    const mock = this.getMockConnection([], pdo);
    pdo.expects(this.once()).method('beginTransaction');
  ...
  it('run method retries on failure', () => {
    ...
    const pdo  = this.createMock(DatabaseConnectionTestMockPDO);
    const mock = this.getMockConnection(['tryAgainIfCausedByLostConnection'], pdo);
  ...
  it('from creates new query builder', () => {
    const conn = this.getMockConnection();
