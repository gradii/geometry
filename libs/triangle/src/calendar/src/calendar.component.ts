...
@Component({
  ...
  template     : `
    <div
      ...
      <div
        [class.ant-fullcalendar-fullscreen]="fullScreen"
        [class.ant-fullcalendar]="!datePicker"
        [class.ant-fullcalendar-full]="!datePicker"
        [class.ant-patch-full-height]="datePicker">
        <div
          [class.ant-fullcalendar-calendar-body]="!datePicker"
          [class.ant-calendar-body]="!datePicker"
          [class.ant-patch-full-height]="datePicker">
          <table
            [class.ant-fullcalendar-table]="!datePicker"
            [class.ant-calendar-table]="datePicker"
            [class.ant-patch-full-height]="datePicker"
            *ngIf="mode == 'year'">
            <thead>
            <tr>
              <th
                *ngFor="let _min of _listOfWeekName"
                [class.ant-fullcalendar-column-header]="!datePicker"
                [class.ant-calendar-column-header]="datePicker">
                <span class="ant-fullcalendar-column-header-inner">{{_min}}</span>
              </th>
            </tr>
            </thead>
            <tbody
              [class.ant-fullcalendartbody]="!datePicker"
              [class.ant-calendartbody]="datePicker">
            <tr *ngFor="let week of _weeksCalendar">
              <ng-template [ngIf]="!datePicker">
                <td
                  [attr.title]="day.title"
                  *ngFor="let day of week.days"
                  [class.ant-fullcalendar-cell]="!datePicker"
                  [class.ant-calendar-cell]="datePicker"
          ...
          <table
            [class.ant-fullcalendar-month-panel-table]="!datePicker"
            [class.ant-calendar-month-panel-table]="datePicker"
            *ngIf="mode == 'month'">
