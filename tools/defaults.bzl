...
_DEFAULT_TSCONFIG_BUILD = "//libs:bazel-tsconfig-build.json"
_DEFAULT_TSCONFIG_TEST = "//libs:bazel-tsconfig-test.json"
...
def ng_web_test_suite(deps = [], static_css = [], bootstrap = [], **kwargs):
  ...
  static_css = static_css + ["//libs/lib/prebuilt-themes:indigo-pink"]
